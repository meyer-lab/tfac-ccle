...
![**Figure 1: Varying numbers of tensor factorization components are reconstructed and plugged into R2X to get the percentage of variance explained in the initial data set by the number of components.** (A) R2X of the protein data subset. (B) R2X of the gene data subset.](./figure1.svg){#fig:fig1}
