...
def form_parafac2_tensor():
    ...
    indTM, atacM, cycIFM, GCPM, L1000M, RNAseqM, RPPAM, treatmentsTime, proteins, chromosomes, IFproteins, histones, L1000GeneExpression, RNAGeneSeq, RPPAproteins = dataCleanUp()
