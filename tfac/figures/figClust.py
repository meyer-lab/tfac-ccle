...
def clustergram_proteins_geneModules():
    ...
    g = sns.clustermap(decreased_proteins, cmap="bwr", method="centroid", center=0, figsize=(14, 20), col_cluster=False)
    ...
    g = sns.clustermap(decreased_genes, cmap="bwr", method="centroid", center=0, figsize=(14, 20), col_cluster=False)
