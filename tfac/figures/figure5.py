...
def makeFigure():
    ...
    g1 = sns.heatmap(drug, cmap="PRGn", center=0, xticklabels=True, yticklabels=True, cbar=False, cbar_ax=ax[5], vmin=-1.0, vmax=1.0, ax=ax[2])
    g1.set_yticklabels(g1.get_yticklabels(), rotation = 0)
    g2 = sns.heatmap(concentrations, cmap="PRGn", center=0, yticklabels=True, cbar=False, vmin=-1.0, vmax=1.0, ax=ax[3])
    g2.set_yticklabels(g2.get_yticklabels(), rotation = 0)
    g3 = sns.heatmap(times, cmap="PRGn", center=0, yticklabels=True, cbar=False, vmin=-1.0, vmax=1.0, ax=ax[4])
    g3.set_yticklabels(g3.get_yticklabels(), rotation = 0)
    g4 = sns.heatmap(G1SG2, cmap="PRGn", center=0, yticklabels=True, cbar=False, vmin=-1.0, vmax=1.0, ax=ax[5])
